          ...
          children: [
            ...
            Padding(
              ...
              child: Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  Text('Sale( + )',style: TextStyle(color: Colors.grey[700])),
                  Container(
                    decoration: BoxDecoration(borderRadius: BorderRadius.circular(4),  color: Colors.green, ),
                    padding: EdgeInsets.all(5),

                    child: Text('Debit', style: TextStyle(color: Colors.white,fontWeight: FontWeight.w500),),
                  ),
                  Text('5000.00', style: TextStyle(color: Colors.green,fontWeight: FontWeight.w500),)
                ],
              ),
            ),
            SizedBox(height: 5,),
            Padding(
              ...
              child: Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  Text('Purchase( - )',style: TextStyle(color: Colors.grey[700])),
                  Container(
                    decoration: BoxDecoration(borderRadius: BorderRadius.circular(4),color: Colors.red, ),
                    padding: EdgeInsets.all(5),
                    
                    child: Text('credit', style: TextStyle(color: Colors.white,fontWeight: FontWeight.w500),),
                  ),
                  Text('2000.00', style: TextStyle(color: Colors.red,fontWeight: FontWeight.w500),)
                ],
              ),
            )
          ],
