                  ...
                  Container(
                    ...
                    child: TextFormField(
                      ...
                      decoration: InputDecoration(
                        ...
                        hintStyle: TextStyle(color: Colors.white, fontSize: 14, fontWeight: FontWeight.w900, letterSpacing: 1)
                      )
                    ),
                  ),
                  SizedBox(height: 10),
                              ...
                              child: Row(
                                children: [
                                  Container(
                                    ...
                                    child: Center(child: Text(model.transactionTypeList[index].sumChetVelDanType.toString()))
                                  ),
                                  SizedBox(width: 2,),
                                  Center(
                                    child:
                                  ...
                                  Expanded(
                                    child: Text(
                                      model.transactionTypeList[index].description,
